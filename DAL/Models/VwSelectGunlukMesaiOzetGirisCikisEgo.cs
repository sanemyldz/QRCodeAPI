...
{
    public partial class VwSelectGunlukMesaiOzetGirisCikisEgo
    {
        ...
        public int DogumIzni { get; set; }
        public int EvlilikIzni { get; set; }
        public int OlumIzni { get; set; }
        public int IdariIzin { get; set; }
        public int UcretsizIzin { get; set; }
        public int Uzaklastirma { get; set; }
        public int Tutuklama { get; set; }
        public int BayramMesaisi { get; set; }
        public int AksamVardiyasi { get; set; }
        public int GeceVardiyasi { get; set; }
        public int Gelmedi { get; set; }
    }
}
