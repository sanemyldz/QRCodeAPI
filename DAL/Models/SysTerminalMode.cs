...
{
    public partial class SysTerminalMode
    {
        public SysTerminalMode()
        {
            TerminalTimeZones = new HashSet<TerminalTimeZone>();
        }
        ...
        public virtual ICollection<TerminalTimeZone> TerminalTimeZones { get; set; }
    }
}
